<template>
  <div class="section">
    <video id="myVideo" class="myVideo" style="cursor: pointer" :src="url" @play="play" @ended="ended"
      :danmu-list="danmuList" enable-danmu danmu-btn controls :poster="poster"></video>
    <div class="btn-area">
      <input class="danmuInput" @blur="bindInputBlur" placeholder="请输入临时弹幕，真实弹幕来自留言" placeholder-style="color:#bbb" />
      <button @tap="addDanmu">点击生成临时弹幕</button>
